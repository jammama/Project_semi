	...
	<!-- calendar 끝 -->
		...
		<div class="detail_main">	
				...
				<input type="hidden" name="todono" value="${dto.todono }">
					<table id="calDetail">
						<tr style="display: none">
							<th>ID</th>
							<td><input type="text" name="projectno" value="${dto.projectno }" readonly="readonly"></td>
						</tr>
						<tr style="display: none">
							<th>일정</th>
							<td>
			...
			%>					 
								 ...
								 <select name="minute" style="display: none">
			<%
									for(int i=1;i<60;i++){
			%>	
			...
			%>						 
						...
						<tr>
							<td style="text-align: left">
							<input id="i5" name="title" type="text" value="&nbsp;&nbsp;${dto.todotitle }" readonly="readonly"></td>
						</tr>
						<tr>
							<td><textarea id="detext" name="content" rows="4" cols="50" style="border-radius: 15px !important;" readonly="readonly">${dto.todocontent }</textarea>
						</tr>
						<tr>
							<td colspan="2">
							<input id="i6" type="button" value="LIST" onclick="history.back(-1)"></td>
						</tr>
					</table>
				</form>
			</div>
